...
brightness = 50
contrast = 50
chunk_length = 3600*1  # Record in chunks (seconds). E.g., 3600 secs = 1 hour
rclone_config = 'lowell_lab:Recordings/'
video_save_path = '/home/nadia/Videos/test'
log_save_path = '/home/nadia/Videos/test'
#-------------------------------------------------------------------------------------------------------
...
class FileOutput(Output):
    ...
    def outputframe(self, frame, keyframe=True, 
                    timestamp=None, packet=None, audio=None):
...
def main():
    ...
    try:
        ...
        # Start recording
        camera.start_recording(encoder, output=output)
